...
int wm = w, hm = h; //tamanio del mapa
...
int segundos_transcurridos; // segundos transcurridos desde el inicio del programa
int milisegundos;
...
void DibujarProyectiles() {
    ...
    glPointSize(8);
    glColor3b(0.858824, 0.439216, 0.858824);
    glBegin(GL_POINTS);
...
void Display_cb() {
  ...
  char st2[10] = "";
  sprintf_s(st2, "%d", segundos_transcurridos);
...
void inicializa() {
  ...
  glutCreateWindow("TP 2"); // crea el main window
